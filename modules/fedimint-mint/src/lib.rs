...
///
/// As things are right now the denomination of each note is determined by the federation
...
///
/// User-generated, random or otherwise unpredictably generated (deterministically derived).
///
